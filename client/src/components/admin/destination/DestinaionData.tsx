...
import { ArrowDownIcon, ArrowUpIcon, BadgeMinus, CheckCircle2 } from "lucide-react";
...
const DestinationData = () => {
    ...
    const fetchDestinations = async () => {
        ...
        try {
            ...
            const res = await axiosPrivate.post(`/api/admin/get-destinations`, encParams);
    ...
    return (
        <>
            <div className="p-4">
                <h2 className="text-2xl font-bold mb-4 text-[#2b5f60]">Destinations</h2>
                <DataTable
                    columns={columns}
                    data={data}
