...
const ShoppingData = () => {
    ...
    const fetchShoppingLocations = async () => {
        ...
        try {
            ...
            const res = await axiosPrivate.post(`/api/admin/get-all-shopping`, encParams);
            ...
            toast("Error!", {
                description: "Something went wrong while fetching shopping locations.",
    ...
    const columns: ColumnDef<ShoppingData>[] = [
        {
            header: "S.No.",
                ...
                const handleToggle = async (checked: boolean) => {
                    try {
                        ...
                        const response = await axiosPrivate.post(
                            "/api/admin/update-shopping-status",
                            formData
                        );
                        const message = JSON.parse(await d(response?.data?.message));
                        if (message === "Shopping Location Status Updated Successfully.") {
