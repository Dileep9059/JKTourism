...
import org.bisag.jktourism.services.TravelAgentService;
...
public class TravelAgentController {
    ...
    public ResponseEntity<String> getAgents(@RequestBody String req) {
        try {
            ...
            return ResponseEntity.ok()
                    .body(Json.serialize(travelAgentService.getAgents(page, size, sort, search, state, district)));
        } catch (Exception e) {
    ...
    public ResponseEntity<String> getDistricts(@RequestBody String req) {
        try {
            ...
            return ResponseEntity.ok()
                    .body(Json.serialize(travelAgentService.getDistricts(json.get("state").asText())));
        } catch (Exception e) {
