...
import org.bisag.jktourism.services.TourGuideService;
...
public class TourGuideController {
    ...
    public ResponseEntity<String> getTourGuides(@RequestBody String req) {
        try {
            ...
            return ResponseEntity.ok()
                    .body(Json.serialize(tourGuideService.getGuides(page, size, sort, search, state, district)));
        } catch (Exception e) {
    ...
    public ResponseEntity<String> getDistricts(@RequestBody String req) {
        try {
            ...
            return ResponseEntity.ok().body(Json.serialize(tourGuideService.getDistricts(json.get("state").asText())));
        } catch (Exception e) {
